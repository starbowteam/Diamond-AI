// ==================== DIAMOND CACHE — надёжное локальное хранилище ====================
...
async function cacheChats(chatsArray) {
    try {
        ...
        console.warn('Ошибка кэширования чатов:', e);
    }
}
...
async function cacheFolders(foldersArray) {
    try {
        ...
        console.warn('Ошибка кэширования папок:', e);
    }
}
...
async function cacheProfile(profile) {
    try {
        ...
        console.warn('Ошибка кэширования профиля:', e);
    }
}
